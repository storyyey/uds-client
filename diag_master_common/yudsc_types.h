#ifndef __YUDSC_TYPES_H__
#define __YUDSC_TYPES_H__

#define __HAVE_UDS_DESC_INFO__ /* √Ë ˆ–≈œ¢ ‰≥ˆ */
...
#ifdef __HAVE_UDS_DESC_INFO__
const char *ydesc_uds_services(yuint32       value);
const char *ydesc_uds_response_codes(yuint32        value);
const char *ydesc_uds_dsc_types(yuint32       value);
const char *ydesc_uds_er_types(yuint32       value);
const char *ydesc_uds_cdtci_group_of_dtc(yuint32 value);
const char *ydesc_uds_rdtci_types(yuint32 value);
const char *ydesc_uds_rdtci_format_id_types(yuint32 value);
const char *ydesc_uds_rsdbi_data_types(yuint32 value);
const char *ydesc_uds_cc_types(yuint32 value);
const char *ydesc_uds_cc_comm_types(yuint32 value);
const char *ydesc_uds_cc_subnet_number_types(yuint32 value);
const char *ydesc_uds_ars_types(yuint32 value);
const char *ydesc_uds_ars_auth_ret_types(yuint32 value);
const char *ydesc_uds_rdbpi_transmission_mode(yuint32 value);
const char *ydesc_uds_dddi_types(yuint32 value);
const char *ydesc_uds_iocbi_parameters(yuint32 value);
const char *ydesc_uds_rc_types(yuint32 value);
const char *ydesc_uds_rft_mode_types(yuint32 value);
const char *ydesc_uds_cdtcs_types(yuint32 value);
const char *ydesc_uds_lc_types(yuint32 value);
const char *ydesc_uds_standard_did_types(yuint32 value);
const char *ydesc_uds_did_resrvdcpadlc_types(yuint32 value);
const char *ydesc_uds_standard_rid_types(yuint32 value);
#endif /* __HAVE_UDS_DESC_INFO__ */

#endif /* __YUDSC_TYPES_H__ */
