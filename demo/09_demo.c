...
int main(int argc, char *argv[])
{
    ...
    ydef_udsc_service_add_statement("111");    
    ydef_udsc_service_variable_byte_set("11111", 2);
    ydef_udsc_service_base_set(0x27, 0x11223344, 0x55667788, ydef_udsc_sub(0x09), \
                        ydef_udsc_delay(500), ydef_udsc_timeout(100), ydef_udsc_34_rd_data_format_identifier(1), \
                        ydef_udsc_34_rd_address_and_length_format_identifier(1), ydef_udsc_34_rd_memory_address(1), \
    ...
    ydef_udsc_runtime_config(om_api, udscid, ydef_udsc_cfg_runtime_statis_enable(1), \
                            ydef_udsc_runtime_fail_abort(1), \
